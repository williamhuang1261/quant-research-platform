 ...
 * is required, and a run that silently defaulted its cost model would be the
 * kind of result that gets quoted without the caveat.
 */
public record BacktestRequest(
        BarSeries series, Strategy strategy, Params params, CostModel costs, double initialCash) {
